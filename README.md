...
## Crime
The crime data set (([crime.config](./tree/master/resources/crime.config))) is from [Edureka, here](https://www.edureka.co/blog/implementing-kmeans-clustering-on-the-crime-dataset/).
